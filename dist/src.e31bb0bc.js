...
},{"gsap":"../node_modules/gsap/index.js"}],"utils/enum.utils.js":[function(require,module,exports) {
...
class EnumUtils {
  constructor() {
    ...
    _defineProperty(this, "ticketStatus", {
      active: "active",
      closed: "closed"
    });
    //Enum of user account statuses
    _defineProperty(this, "accountStatus", {
      active: "active",
      banned: "banned",
      warned: "warned",
      suspended: "suspended"
    ...
    _defineProperty(this, "reportTargetType", {
...
},{}],"services/AuthAPI.js":[function(require,module,exports) {
"use strict";
...
class AuthAPI {
    ...
    if (!response.ok) {
      ...
      if (data.code) {
        ...
        if (data.code == "WARNED") {
          ...
          if (data.user.accessLevel != _enum.default.accessLevels.restaurant) _Toast.default.show("Welcome,  ".concat(data.user.firstName));
          //Welcome a restaurant
          else if (data.user.accessLevel == _enum.default.accessLevels.restaurant) _Toast.default.show("Welcome,  ".concat(data.user.restaurantName));
        ...
        //Inform user of suspension and for the span
          ...
          _Toast.default.show(data.message);
          fail();
      ...
      //No demerits to handle
        ...
        if (this.currentUser.showIntro == true) (0, _Router.gotoRoute)('/intro');
        //Direct to the home/profile page on login
        else (0, _Router.gotoRoute)('/');
      }
    }
  }
   ...
   */
  signOut() {
    let message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "You are signed out";
    _Toast.default.show(message);
    // delete local token
    localStorage.removeItem('accessToken');
...
},{"../App":"App.js","../Router":"Router.js","lit-html":"../node_modules/lit-html/lit-html.js","../Toast":"Toast.js","../utils/enum.utils":"utils/enum.utils.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
class ErrorView {
   ...
   */
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["   \n    <app-header title=", " user=", "></app-header> \n      <div class=\"page-content\">\n        <h1>Opps!</h1>\n        <p>Sorry, we couldn't find that.</p>\n      </div>\n      <app-footer title=", "></app-footer>\n    "])), document.title, JSON.stringify(_AuthAPI.default.currentUser), document.title);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new ErrorView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js"}],"views/pages/auth.js":[function(require,module,exports) {
"use strict";
...
var _default = new AuthView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js"}],"../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
...
class UserAPI {
  ...
  */
  async giveDemerit(userId) {
    ...
    //Await PUT request on server
    const response = await fetch("".concat(_App.default.apiBase, "/user/give-demerit/").concat(userId), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
  ...
  async updateWarningStatus(userId, userData) {
    ...
    //Await PUT request on server
    const response = await fetch("".concat(_App.default.apiBase, "/user/warning-status/").concat(userId), {
      method: "PUT",
      headers: headerOptions,
      body: userData
    });
  ...
  async deleteById(userId) {
    ...
    //Sign the user out
    _AuthAPI.default.signOut("Your account has been deleted");
  }
  ...
  async getNumPages() {
    ...
    let userType = arguments.length > 1 ? arguments[1] : undefined;
    //Fetch json array
    const response = await fetch("".concat(_App.default.apiBase, "/user/").concat(userType, "/").concat(keywords), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
  ...
  async getRestaurantName(restaurantId) {
    //Await GET request to server
    const response = await fetch("".concat(_App.default.apiBase, "/user/restaurant-name/").concat(restaurantId), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
...
exports.default = _default;
},{"../App":"App.js","./AuthAPI":"services/AuthAPI.js","../Toast":"Toast.js","@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js"}],"views/partials/mascot.partial.js":[function(require,module,exports) {
"use strict";
...
var _enum = _interopRequireDefault(require("../../utils/enum.utils"));
var _Toast = _interopRequireDefault(require("../../Toast"));
var _mascot = _interopRequireDefault(require("../partials/mascot.partial"));
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","moment":"../node_modules/moment/moment.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js","../../Toast":"Toast.js","../partials/mascot.partial":"views/partials/mascot.partial.js"}],"utils/pagination.utils.js":[function(require,module,exports) {
"use strict";
...
class PaginationUtils {
  ...
  async updatePaginationButtons(numPages) {
    ...
    if (!numPages) {
      ...
      this.disableButton("".concat(prevBtnSelector, ", ").concat(nextBtnSelector));
    }
...
var _default = new PaginationUtils();
exports.default = _default;
},{}],"views/pages/search-restaurants.js":[function(require,module,exports) {
"use strict";
  ...
  */
  async loadData(isNextPage) {
    ...
    if (isNextPage == true || isNextPage == false) {
      ...
      if (isNextPage == true) {
        _pagination.default.incrementPage();
      }
      //Decrement for previous page
      else if (isNextPage == false) {
        _pagination.default.decrementPage();
      }
    }
  ...
  async renderListings(data) {
    ...
    for (const item of data) {
      listingTemplates.push((0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<restaurant-listing restaurant=", "></restaurant-listing>"])), JSON.stringify(item)));
    }

    //Render review listing template array to restaurants container
    (0, _litHtml.render)(listingTemplates, document.getElementById("restaurants-container"));
  }
   ...
   */
  render() {
    const template = (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n\n    <app-header title=\"", "\" user=\"", "\"></app-header>\n\n    <div class=\"page-content\">\n\n    <div class=\"search-container\">\n      <h1>Search Restaurants</h1>\n\n\n\n     <sl-form class=\"form-search\" @sl-submit=", ">       \n        \n               <sl-input name=\"keywords\" type=\"text\" placeholder=\"Restaurant Name\"></sl-input>\n            <sl-button class=\"submit-btn\" id=\"search-submit-btn\" type=\"primary\" submit>Search Restaurants</sl-button>\n           </sl-form>      \n    </div>\n\n\n        <div class=\"pagination\">\n        <sl-button class=\"prev-page-btn\" @click=", " class=\"prev\">Previous</sl-button>\n        <sl-button class=\"next-page-btn\" @click=", " class=\"next\">Next</sl-button>\n      </div>\n           <div id=\"restaurants-container\">\n           </div>\n\n\n           <div class=\"pagination\">\n        <sl-button class=\"prev-page-btn\" @click=", " class=\"prev\">Previous</sl-button>\n        <sl-button class=\"next-page-btn\" @click=", " class=\"next\">Next</sl-button>\n      </div>\n           \n    \n    </div>\n\n    <app-footer title=", "></app-footer>\n    \n    "])), document.title, JSON.stringify(_AuthAPI.default.currentUser), this.searchSubmitHandler.bind(this), () => this.loadData(false), () => this.loadData(true), () => this.loadData(false), () => this.loadData(true), document.title);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new SearchRestaurantsView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","moment":"../node_modules/moment/moment.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js","../../utils/pagination.utils":"utils/pagination.utils.js"}],"services/ReportAPI.js":[function(require,module,exports) {
"use strict";
...
class ReportAPI {
  ...
  */
  async create(reportData) {
    ...
    const response = await fetch("".concat(_App.default.apiBase, "/report/"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
      method: 'POST',
  ...
  async updateById(reportId, reportData) {
    ...
    //Await PUT request on server
    const response = await fetch("".concat(_App.default.apiBase, "/report/").concat(reportId), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
  ...
  */
  ...
  async deleteById(reportId) {
    ...
    _Toast.default.show('report deleted');
  }
  ...
  async closeTicket(reportId) {
    ...
    //Await PUT request on server
    const response = await fetch("".concat(_App.default.apiBase, "/report/close-report/").concat(reportId, "/").concat(_AuthAPI.default.currentUser._id), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
...
var _default = new ReportAPI();
exports.default = _default;
},{"../App":"App.js","./AuthAPI":"services/AuthAPI.js","../Toast":"Toast.js"}],"services/ReviewAPI.js":[function(require,module,exports) {
"use strict";
...
class ReviewAPI {
  ...
  */
  async create(reviewData) {
    ...
    //Await POST request to server
    const response = await fetch("".concat(_App.default.apiBase, "/review/"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
      method: 'POST',
    ...
    if (!response.ok) {
      ...
      if (err.message) {
        _Toast.default.show(err.message, 'error');
      } else {
        //Throw new error    
  ...
  async getById(reviewId) {
    ...
    //Await GET request to server
    const response = await fetch("".concat(_App.default.apiBase, "/review/").concat(reviewId), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
  ...
  */
  async getAvgReviewScore(restaurantId) {
    ...
    //Await GET request to server
    const response = await fetch("".concat(_App.default.apiBase, "/review/avg-score/").concat(restaurantId), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
  ...
  async deleteById(reviewId) {
    ...
    _Toast.default.show('Review deleted');
  }
  ...
  async getNumPages(id) {
    //Fetch json array
    const response = await fetch("".concat(_App.default.apiBase, "/review/").concat(id, "/").concat(_AuthAPI.default.currentUser.accessLevel), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
  ...
  async getRestaurantReviews(page) {
    //Fetch json array
    const response = await fetch("".concat(_App.default.apiBase, "/review/").concat(_AuthAPI.default.currentRestaurant._id, "/").concat(page, "/").concat(_enum.default.accessLevels.restaurant), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
...
var _default = new ReviewAPI();
exports.default = _default;
},{"../App":"App.js","./AuthAPI":"services/AuthAPI.js","../Toast":"Toast.js","../utils/enum.utils":"utils/enum.utils.js"}],"views/pages/admin/search-reports.js":[function(require,module,exports) {
"use strict";
...
class ActiveTicketsView {
  ...
  */
  async loadData(isNextPage) {
    ...
    //Find number of pages
    const numPages = await _ReportAPI.default.getNumPages(this.status, this.targetType);
  ...
  async renderListings(data) {
    ...
    (0, _litHtml.render)(listingTemplates, document.getElementById('reports-container'));
  }
...
var _default = new ActiveTicketsView();
exports.default = _default;
},{"../../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","moment":"../node_modules/moment/moment.js","../../../services/UserAPI":"services/UserAPI.js","../../../utils/enum.utils":"utils/enum.utils.js","../../../services/ReportAPI":"services/ReportAPI.js","../../../services/ReviewAPI":"services/ReviewAPI.js","../../../utils/pagination.utils":"utils/pagination.utils.js"}],"views/pages/admin/report.js":[function(require,module,exports) {
"use strict";
...
class ReportView {
  ...
  render() {
    ...
    const template = (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["   \n\n\n<style>\n\n\n      #report-container {\n        display: flex;\n        flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      width: 700px;\n      border: 4px solid var(--brand-color);\n         padding:20px;\n\n      border-radius:20px;\n      }\n\n.top, #show-btn { \n              gap:40px;              \n              margin-bottom:20px;\n            }\n\n\n\n            .mid {\n                          display:flex;\n              flex-direction:column;\n              align-items:start;   \n              width:90%;   \n              margin-bottom:20px;\n              margin-top:20px;\n            }\n\n\n\n\n            .mid .top {\n              display:flex;\n              flex-direction:column;\n              align-items:start;  \n              width:fit-content;\n              padding:10px;\n              box-shadow: var(--main-content-box-shadow); \n            }\n\n\n            .mid .bot {\n              display:flex;\n              flex-direction:column;\n              align-items:start;    \n              padding:10px;\n              box-shadow: var(--main-content-box-shadow); \n            }\n\n            .bot {\n              display:flex;\n              flex-direction:row;\n              justify-content:space-between;\n              width:80%;\n              align-items:center;\n            }\n\n            #show-flagged-content-btn {\n              width:200px;\n            }\n\n\n            sl-dialog::part(header) {\nwidth:100%;\n            }\n\n       \nsl-dialog::part(panel) {\n    width:95vw;\n    align-items:center;\n\n}\n\n\n.bold-text {\n    font-size:var(--label-font-size);\n  font-weight:var(--label-font-weight);\n  }\n\n\n@media all and (max-width: 768px) { \n\n  #report-container {\n      width: 90vw;\n      border: none;\n      }\n\n            .bot {\n              flex-direction:column;\n              gap:20px;\n            }\n\n            sl-dialog::part(panel) {\n    width:100vw;\n}\n\n\n\n\n  }\n  \n\n</style>\n\n\n\n    <app-header title=", " user=\"", "\"></app-header>\n\n    \n    <sl-dialog id=\"report-target-dialog\" label=\"Flagged Content\" class=\"dialog-overview\">\n      ", "\n  <sl-button @click=\"", "\" slot=\"footer\">Close</sl-button>\n</sl-dialog>\n\n    <div class=\"page-content\">\n\n    <div id=\"report-container\">\n             <h1>Report Ticket</h1>     \n\n      <div class=\"mid\">\n       <sl-button id=\"show-btn\" @click=\"", "\">View Flagged Content</sl-button>     \n        <div class=\"top\">\n                   \n        <div class=\"reporter-container\"><span class=\"bold-text\">Reporter ID: </span><span>", "</span></div>\n        <div class=\"topic-container\"><span class=\"bold-text\">Topic: </span><span>", "</span></div>\n        </div>  \n        <div class=\"comment-container bot\">\n          <h3>Comment</h3>\n          <p>", "</p>\n        </div>\n      </div>\n      <div class=\"bot\">\n      <sl-button id=\"close-ticket-btn\" @click=", " >Close Ticket</sl-button>\n      <sl-button id=\"disciplinary-btn\" @click=", ">Disciplinary Action</sl-button>\n      </div>\n    </div>\n\n    </div>\n    \n    <app-footer title=", "></app-footer>\n    \n    "])), document.title, JSON.stringify(_AuthAPI.default.currentUser), flaggedContent, () => {
    ...
    }, () => document.getElementById('report-target-dialog').show(), _AuthAPI.default.currentReport.authorId, _AuthAPI.default.currentReport.topic, _AuthAPI.default.currentReport.text, () => _ReportAPI.default.closeTicket(_AuthAPI.default.currentReport._id), () => {
      ...
      if (_AuthAPI.default.currentReport.targetType == "") {
...
},{"../../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","moment":"../node_modules/moment/moment.js","../../../services/UserAPI":"services/UserAPI.js","../../../services/ReviewAPI":"services/ReviewAPI.js","../../../services/ReportAPI":"services/ReportAPI.js","../../../Toast":"Toast.js","../../../utils/enum.utils":"utils/enum.utils.js"}],"views/pages/edit-profile.js":[function(require,module,exports) {
"use strict";
...
class EditProfileView {
   ...
   */
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <app-header title=", " user=", "></app-header>\n      <div class=\"page-content\">        \n        ", "\n      </div>\n\n      <app-footer title=", "></app-footer>\n    "])), document.title, JSON.stringify(_AuthAPI.default.currentUser), _AuthAPI.default.currentUser == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  <edit-profile-form title=", "></edit-profile-form>\n        "])), document.title), document.title);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new EditProfileView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/UserAPI":"services/UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"../node_modules/lit-html/directives/until.js":[function(require,module,exports) {
"use strict";
...
exports.until = until;
},{"../lib/parts.js":"../node_modules/lit-html/lib/parts.js","../lit-html.js":"../node_modules/lit-html/lit-html.js"}],"../node_modules/lit/node_modules/lit-html/directive.js":[function(require,module,exports) {
"use strict";
...
exports.Directive = i;
},{}],"../node_modules/lit/node_modules/lit-html/lit-html.js":[function(require,module,exports) {
"use strict";
...
exports._$LH = Z;
null == j || j(V, M), (null !== (t = i.litHtmlVersions) && void 0 !== t ? t : i.litHtmlVersions = []).push("2.7.3");
const B = (t, i, s) => {
  var e, o;
...
exports.render = B;
},{}],"../node_modules/lit/node_modules/lit-html/directive-helpers.js":[function(require,module,exports) {
"use strict";
...
},{"./lit-html.js":"../node_modules/lit/node_modules/lit-html/lit-html.js"}],"../node_modules/lit/node_modules/lit-html/async-directive.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "PartType", {
  enumerable: true,
  get: function () {
...
class c extends _directive.Directive {
  constructor() {
...
exports.AsyncDirective = c;
},{"./directive-helpers.js":"../node_modules/lit/node_modules/lit-html/directive-helpers.js","./directive.js":"../node_modules/lit/node_modules/lit-html/directive.js"}],"../node_modules/lit/node_modules/lit-html/directives/private-async-helpers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forAwaitOf = exports.PseudoWeakRef = exports.Pauser = void 0;
/**
 * @license
...
exports.Pauser = i;
},{}],"../node_modules/lit/node_modules/lit-html/directives/async-replace.js":[function(require,module,exports) {
"use strict";
...
var _privateAsyncHelpers = require("./private-async-helpers.js");
var _directive = require("../directive.js");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class o extends _asyncDirective.AsyncDirective {
  constructor() {
    super(...arguments), this._$Cq = new _privateAsyncHelpers.PseudoWeakRef(this), this._$CK = new _privateAsyncHelpers.Pauser();
  }
  render(i, s) {
  ...
  update(i, [s, r]) {
    ...
    return (0, _privateAsyncHelpers.forAwaitOf)(s, async t => {
...
exports.AsyncReplaceDirective = o;
const h = (0, _directive.directive)(o);
exports.asyncReplace = h;
},{"../lit-html.js":"../node_modules/lit/node_modules/lit-html/lit-html.js","../async-directive.js":"../node_modules/lit/node_modules/lit-html/async-directive.js","./private-async-helpers.js":"../node_modules/lit/node_modules/lit-html/directives/private-async-helpers.js","../directive.js":"../node_modules/lit/node_modules/lit-html/directive.js"}],"../node_modules/lit/node_modules/lit-html/directives/async-append.js":[function(require,module,exports) {
"use strict";
...
var _directive = require("../directive.js");
var _asyncReplace = require("./async-replace.js");
var _directiveHelpers = require("../directive-helpers.js");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const c = (0, _directive.directive)(class extends _asyncReplace.AsyncReplaceDirective {
  constructor(r) {
    if (super(r), r.type !== _directive.PartType.CHILD) throw Error("asyncAppend can only be used in child expressions");
  }
  update(r, e) {
  ...
  commitValue(r, e) {
    ...
    const s = (0, _directiveHelpers.insertPart)(this._$CJ);
    (0, _directiveHelpers.setChildPartValue)(s, r);
  }
});
exports.asyncAppend = c;
},{"../directive.js":"../node_modules/lit/node_modules/lit-html/directive.js","./async-replace.js":"../node_modules/lit/node_modules/lit-html/directives/async-replace.js","../directive-helpers.js":"../node_modules/lit/node_modules/lit-html/directive-helpers.js"}],"../node_modules/lit/directives/async-append.js":[function(require,module,exports) {
"use strict";
...
Object.keys(_asyncAppend).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _asyncAppend[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _asyncAppend[key];
    }
  });
});
},{"lit-html/directives/async-append.js":"../node_modules/lit/node_modules/lit-html/directives/async-append.js"}],"views/pages/reviews.js":[function(require,module,exports) {
"use strict";
...
var _asyncAppend = require("lit/directives/async-append.js");
var _litElement = require("@polymer/lit-element");
var _enum = _interopRequireDefault(require("../../utils/enum.utils"));
var _pagination = _interopRequireDefault(require("../../utils/pagination.utils"));
var _templateObject, _templateObject2;
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","moment":"../node_modules/moment/moment.js","../../services/UserAPI":"services/UserAPI.js","../../services/ReviewAPI":"services/ReviewAPI.js","lit-html/directives/until.js":"../node_modules/lit-html/directives/until.js","lit/directives/async-append.js":"../node_modules/lit/directives/async-append.js","@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../utils/enum.utils":"utils/enum.utils.js","../../utils/pagination.utils":"utils/pagination.utils.js"}],"views/pages/restaurant.js":[function(require,module,exports) {
"use strict";
...
class RestaurantView {
  ...
  async loadData(isNextPage) {
    ...
    //Find number of pages
    const numPages = await _ReviewAPI.default.getNumPages(_AuthAPI.default.currentRestaurant._id);

    //Disable/enable pagination buttons
    _pagination.default.updatePaginationButtons(numPages);

    //Get page of data
    const data = await _ReviewAPI.default.getPage(this.currPage, _AuthAPI.default.currentRestaurant._id, _enum.default.accessLevels.restaurant);
    //Render data listing array to container element
    this.renderListings(data);
  }
...
var _default = new RestaurantView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/UserAPI":"services/UserAPI.js","../../services/ReviewAPI":"services/ReviewAPI.js","../../utils/enum.utils":"utils/enum.utils.js","../../utils/pagination.utils":"utils/pagination.utils.js"}],"views/pages/introduction.js":[function(require,module,exports) {
"use strict";
...
class IntrodoctionView {
  ...
  render() {
    ...
    if (_AuthAPI.default.currentUser.accessLevel == _enum.default.accessLevels.reviewer) content = this.reviewerTemplate();
    //Build the restaurant template
    else if (_AuthAPI.default.currentUser.accessLevel == _enum.default.accessLevels.restaurant) content = this.restaurantTemplate();
    //Build the admin template
    else if (_AuthAPI.default.currentUser.accessLevel == _enum.default.accessLevels.administrator) content = this.adminTemplate();
    const template = (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["   \n\n\n    <app-header title=\"Introduction\" user=", "></app-header> \n<div class=\"page-content\">\n  <div class=\"intro-guide\">\n", "\n  </div>\n\n</div>\n  \n      <app-footer title=", "></app-footer>\n    "])), JSON.stringify(_AuthAPI.default.currentUser), content, document.title);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new IntrodoctionView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _auth = _interopRequireDefault(require("./views/pages/auth"));
var _profile = _interopRequireDefault(require("./views/pages/profile"));
var _searchRestaurants = _interopRequireDefault(require("./views/pages/search-restaurants"));
var _searchReports = _interopRequireDefault(require("./views/pages/admin/search-reports"));
var _report = _interopRequireDefault(require("./views/pages/admin/report"));
var _editProfile = _interopRequireDefault(require("./views/pages/edit-profile"));
var _reviews = _interopRequireDefault(require("./views/pages/reviews"));
var _restaurant = _interopRequireDefault(require("./views/pages/restaurant"));
var _introduction = _interopRequireDefault(require("./views/pages/introduction"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/**
...
const routes = {
  '/': _profile.default,
  '/home': _profile.default,
  '/profile': _profile.default,
  '404': _.default,
  '/login': _auth.default,
  '/search': _searchRestaurants.default,
  '/edit-profile': _editProfile.default,
  '/reviews': _reviews.default,
  '/restaurant': _restaurant.default,
  '/active-tickets': _searchReports.default,
  //'/ticket-history':ticketHistory,
  '/report': _report.default,
  '/intro': _introduction.default
};
class Router {
  constructor() {
    this.routes = routes;
...
},{"./views/pages/404":"views/pages/404.js","./views/pages/auth":"views/pages/auth.js","./views/pages/profile":"views/pages/profile.js","./views/pages/search-restaurants":"views/pages/search-restaurants.js","./views/pages/admin/search-reports":"views/pages/admin/search-reports.js","./views/pages/admin/report":"views/pages/admin/report.js","./views/pages/edit-profile":"views/pages/edit-profile.js","./views/pages/reviews":"views/pages/reviews.js","./views/pages/restaurant":"views/pages/restaurant.js","./views/pages/introduction":"views/pages/introduction.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./Router":"Router.js","./services/AuthAPI":"services/AuthAPI.js","./Toast":"Toast.js"}],"components/base/header.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('app-header', class AppHeader extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  initMascotAnim(headerLogos) {
    ...
    //Initialise timeline
    var mascotTimeline = _gsap.default.timeline(tlOptions);
  ...
  render() {
    ...
    return (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n\n    <style>\n\n\nh1 {\n  font-size: var(--h1-font-size);\n    font-weight:var(--h1-font-weight);\n    font-family:var(--heading-font-family);\n  color:var(--light-txt-color);\n  margin:0;\n}\n\n\n\n    header {\n      overflow: hidden;\n      position:fixed;\n      top:0;\n      z-index: 1;\n       width:100%;\n      height: 150px;\n      background: var(--brand-color);\n        display:flex;\n       flex-direction:row;\n      justify-content: space-between; \n       align-items: center;\n       margin-bottom: 50px;\n       padding:10px;\n    }\n\n.header-logo {\n  color:var(--heading-txt-color);\n  text-align: center;\n  text-decoration: none;\n}\n\n    .header-logo-container {\n      display:flex;\n      flex-direction:column;\n      align-items:center;\n    }\n\n\np, span, a {\n  font-family:var(--txt-font-family);\n}\n    \n\n\n    nav {    \n      display: flex;\n      flex-direction: row;\n      align-items:center;\n      justify-content:space-between;\n      padding-right:20px;\n      width:500px;\n    }\n\n    .nav-links {\n      display: flex;\n      flex-direction: row;\n      width:500px;\n      gap:5px;\n    }\n\n   .nav-links a {\n      display:flex;\n      flex-direction:column;\n      width:140px;\n      height: 50px;\n      background: #FFFFFF;\n      margin-left: 15px;\n      margin-right: 15px;\n      padding:5px;\n      border-radius: 20px;\n      text-align: center;\n      justify-content: center;\n      font-weight: var(--nav-font-weight);\n      font-size: var(--nav-font-size);\n      color:var(--base-txt-color);\n    }\n\n    .nav-links a, .header-logo {\n      text-decoration:none;\n    }\n\n    .signout-link {\n      font-size:var(--signout-font-size);\n      font-weight:var(--signout-font-weight);\n      color:var(--light-txt-color);\n          align-self:start;\n          position:fixed;\n          top:10px;\n          right:20px;\n    }\n\n\n\n\n\n\n    .active {\n      background:var(--secondary-brand-color);\n    }\n\n\n    /* RESPONSIVE - MOBILE -------------------*/\n@media all and (max-width: 768px)  { \n\n  .header-logo h1 {\n    display:none;\n  }\n\n  .header-logo {\n    float: none;\n    display: block;\n  }\n\n  nav {\n    width:100vw;\n    justify-content:center;\n  }\n\n  .nav-links {\n    width:100%;\n  }\n\n\n\n  header {\n    display:flex;\n    flex-direction:column;\n    gap:5px;\n    padding:5px;\n  }\n\n\n  .signout-link {\n    margin-left:15px;\n  }\n\n  }\n\n\n\n    </style>\n\n    <header class=\"app-header\">\n    ", "  \n</header>\n    "])), localStorage.getItem('accessToken') ? (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral([" \n\n    <a class=\"header-logo\" href=\"/\" \n    @click=\"", "\">\n    <div class=\"header-logo-container\">\n    ", "\n   <h1>Grub Hunters</h1>\n  </div>\n</a>\n\n        <nav class=\"app-top-nav\">  \n          <div class=\"nav-links\">\n     ", "       \n          </div>    \n    </nav>\n    <a class=\"signout-link\" href=\"#\" @click=\"", "\">Sign Out</a>\n    "])), () => {
      ...
      _Router.anchorRoute;
    }, _mascot.default, headerLinks, () => _AuthAPI.default.signOut()) : (0, _litElement.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    \n    <style>\n  header {\n             margin:0;   \n      justify-content:center;        \n  }\n    </style>\n\n    \n    <div class=\"header-logo-container\">", "<h1>Grub Hunters</h1></div>"])), _mascot.default));
  }
});
...
customElements.define('app-footer', class AppFooter extends _litElement.LitElement {
  constructor() {
    super();
  }
...
customElements.define('login-form', class LoginForm extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  */
  signInSubmitHandler(e) {
    ...
    _AuthAPI.default.signIn(formData, () => {
      submitBtn.removeAttribute('loading');
    });
  }
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('register-form', class RegisterForm extends _litElement.LitElement {
  constructor() {
    super();
  ...
  */
  registerSubmitHandler(e) {
    ...
    // sign in using Auth    
    _AuthAPI.default.signUp(formData, () => {
      submitBtn.removeAttribute('loading');
    });
  }
  ...
  updateFormFields(e) {
    ...
    if (e.target.getAttribute("checked") == "") e.target.innerHTML = "Restaurant";else if (e.target.getAttribute("checked") == null) e.target.innerHTML = "Reviewer";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('report-form', class ReportForm extends _litElement.LitElement {
  constructor() {
    super();
  }
   ...
   */
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n\n<style>\n\nsl-form {\n  align-items:center;\n}\n\nsl-input::part(input) {\n  font-size:var(--input-font-size);\n  font-weight:var(--input-font-weight);\n}\n\nsl-input {\n  --label-width:6rem;\n--gap-width:2rem;\n  margin-top: var(--sl-spacing-medium);  \n}\n\n\nlabel, sl-input {\n    font-size:var(--label-font-size);\n  font-weight:var(--label-font-weight);\n}\n\n\n\nsl-input::part(form-control-label) {\n  text-align: right;\n  align-self: center;\n  margin-right:20px;\n}\n\n\nsl-input::part(form-control) {\n  display:grid;\n  grid: auto / var(--label-width) 1fr;\n  gap: 20px;\n}\n\n</style>\n\n\n<sl-form class=\"page-form\" @sl-submit=", ">\n\n<input type=\"hidden\" name=\"authorId\" value=\"", "\">\n<input type=\"hidden\" name=\"targetId\" value=\"", "\" >\n\n<sl-input label=\"Topic\" type=\"text\" name=\"topic\" placeholder=\"Topic\" required></sl-input>\n<sl-input label=\"Description\" type=\"text\" name=\"text\" placeholder=\"Details\" required></sl-input>\n<input type=\"hidden\" name=\"targetType\" value=", " >\n\n      <sl-button id=\"report-submit-btn\" type=\"primary\" class=\"submit-btn\" submit>Post Report</sl-button>\n    </sl-form>"])), this.createReportSubmitHandler.bind(this), _AuthAPI.default.currentUser._id, this.target_id, this.target_type);
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","../../../App":"App.js","../../../Toast":"Toast.js","../../../services/ReportAPI":"services/ReportAPI.js"}],"components/forms/create/review.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('review-form', class ReviewForm extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  async createReviewSubmitHandler(e) {
    ...
    submitBtn.setAttribute('loading', '');
    try {
      const response = await _ReviewAPI.default.create(formData);
      console.log(response);
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","../../../App":"App.js","../../../Toast":"Toast.js","../../../services/ReviewAPI":"services/ReviewAPI.js"}],"components/forms/edit/profile.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('edit-profile-form', class EditProfileForm extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  async updateProfileSubmitHandler(e) {
    ...
    const formData = e.detail.formData;
    try {
      const updatedUser = await _UserAPI.default.updateById(_AuthAPI.default.currentUser._id, formData);
      delete updatedUser.password;
      _AuthAPI.default.currentUser = updatedUser;
      _AuthAPI.default.currentUser = updatedUser;
      this.render();
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","../../../App":"App.js","../../../services/ReviewAPI":"services/ReviewAPI.js"}],"components/list/review.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('review-listing', class ReviewListing extends _litElement.LitElement {
  ...
  firstUpdated() {
    ...
    if (!this.restaurant_name) this.getRestaurantName();
  }
  ...
  async getRestaurantName() {
    const data = await _UserAPI.default.getRestaurantName(_AuthAPI.default.currentTarget.restaurantId);
  ...
  buildRatingDisplay() {
    ...
    if (this.review.rating < 5 && this.review.rating > 0) return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n      .rating-display {\n        background:var(--low-rating);\n      }\n</style>\n<div class=\"rating-display\"><span class=\"rating-display-text\">", "/10</span></div>"])), this.review.rating);
    //Render mid rating display
    else if (this.review.rating >= 5 && this.review.rating < 6.9) return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n<style>\n  .rating-display {\n    background:var(--mid-rating);\n  }\n</style>\n<div class=\"rating-display\"><span class=\"rating-display-text\">", "/10</span></div>"])), this.review.rating);
    //Render high rating display
    else if (this.review.rating >= 7) return (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n<style>\n  .rating-display {\n    background:var(--high-rating);\n  }\n</style>\n<div class=\"rating-display\"><span class=\"rating-display-text\">", "/10</span></div>"])), this.review.rating);
  }
  ...
  async voteReview(vote) {
    ...
    if (vote == "upvote") {
      this.review.upvotes++;
      this.review.upvoters.push(_AuthAPI.default.currentUser._id);
      if (this.review.downvoters.includes(_AuthAPI.default.currentUser._id)) {
    ...
    //Downvote the review, remove upvote if it exists
      ...
      this.review.downvotes++;
      this.review.downvoters.push(_AuthAPI.default.currentUser._id);
      if (this.review.upvoters.includes(_AuthAPI.default.currentUser._id)) {
        this.review.upvotes--;
    ...
    await _ReviewAPI.default.updateById(this.review._id, JSON.stringify(this.review), true);
  }
  ...
  buildVoteDisplay() {
    ...
    //Enable voting for non-authors 
      ...
      return (0, _litElement.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      ", "\n      \n        ", ""])), this.review.upvoters.includes(_AuthAPI.default.currentUser._id) ? (0, _litElement.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n       <div class=\"vote-container\"><sl-button id=\"upvote-btn\" disabled @click=", ">Upvote</sl-button><div>Upvotes: ", "</div></div> \n        "])), () => {
        this.voteReview('upvote');
      }, this.review.upvotes) : (0, _litElement.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n          <div class=\"vote-container\"><sl-button id=\"upvote-btn\" @click=", ">Upvote</sl-button><div>Upvotes: ", "</div></div> \n        "])), () => {
        this.voteReview('upvote');
      }, this.review.upvotes), this.review.downvoters.includes(_AuthAPI.default.currentUser._id) ? (0, _litElement.html)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n       <div class=\"vote-container\"><sl-button id=\"downvote-btn\" disabled @click=", ">Downvote</sl-button><div>Downvotes: ", "</div></div> \n        "])), () => {
        this.voteReview('downvote');
      }, this.review.downvotes) : (0, _litElement.html)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n          <div class=\"vote-container\"><sl-button id=\"downvote-btn\" @click=", ">Downvote</sl-button><div>Downvotes: ", "</div></div> \n        "])), () => {
        this.voteReview('downvote');
      }, this.review.downvotes));
    }
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../App":"App.js","../../services/ReviewAPI":"services/ReviewAPI.js","../../Toast":"Toast.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js"}],"components/list/restaurant.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('restaurant-listing', class RestaurantListing extends _litElement.LitElement {
  constructor() {
    super();
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../App":"App.js","../../utils/enum.utils":"utils/enum.utils.js"}],"components/list/report.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('report-listing', class ReportListing extends _litElement.LitElement {
  constructor() {
    super();
  }
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('reviewer-profile', class ReviewerProfile extends _litElement.LitElement {
  constructor() {
    super();
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../App":"App.js","moment":"../node_modules/moment/moment.js","../../services/UserAPI":"services/UserAPI.js"}],"components/profile/restaurant.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('restaurant-profile', class RestaurantProfile extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  static get properties() {
    return {
      ...
      ratingDisplayTemplate: {
        type: _litElement.TemplateResult
      }
    };
  }
  ...
  async getAvgRating() {
    ...
    const data = await _ReviewAPI.default.getAvgReviewScore(this.restaurant._id);
  ...
  */
  render() {
    ...
    let editProfileBtn = (0, _litElement.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral([""])));
    ...
    //Render UI if this is not your profile
      ...
      if (!this.is_report) {
        reportAccountBtn = (0, _litElement.html)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n        <sl-button id=\"report-btn\" @click=\"", "\">Report</sl-button>      \n        "])), () => this.shadowRoot.getElementById('report-dialog').show());
      }
    }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/ReportAPI":"services/ReportAPI.js","../../App":"App.js","../../utils/enum.utils":"utils/enum.utils.js","../../services/UserAPI":"services/UserAPI.js","../../services/ReviewAPI":"services/ReviewAPI.js"}],"components/profile/admin.component.js":[function(require,module,exports) {
"use strict";
...
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /**
                                                                                                                                                                                         ...
                                                                                                                                                                                         */ //Import dependencies
//Define custom element
customElements.define('admin-profile', class AdminProfile extends _litElement.LitElement {
  constructor() {
    super();
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../App":"App.js","moment":"../node_modules/moment/moment.js","../../services/UserAPI":"services/UserAPI.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
require("./components/base/header.component.js");
require("./components/base/footer.component.js");
require("./components/forms/auth/login.component.js");
require("./components/forms/auth/register.component.js");
...
require("./components/profile/reviewer.component.js");
require("./components/profile/restaurant.component.js");
require("./components/profile/admin.component.js");
