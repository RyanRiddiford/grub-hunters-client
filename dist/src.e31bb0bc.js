...
class App {
  constructor() {
    ...
    this.version = "1.0.0";
    //Establish the api url. Use this when testing the api locally: 'http://localhost:3000';
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../App":"App.js","../../utils/enum.utils":"utils/enum.utils.js","../../services/UserAPI":"services/UserAPI.js","../../services/ReviewAPI":"services/ReviewAPI.js"}],"components/profile/admin.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('admin-profile', class AdminProfile extends _litElement.LitElement {
   ...
   */
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["   \n    \n    <style>\n\nh1 {\n     font-size: var(--h1-font-size);\n     font-weight:var(--h1-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n h2 {\n     font-size: var(--h2-font-size);\n     font-weight:var(--h2-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n h3 {\n     font-size: var(--h3-font-size);\n     font-weight:var(--h3-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n .bold-text {\n     font-size:var(--label-font-size);\n     font-weight:var(--label-font-weight);\n}\n .profile {\n     display:flex;\n     flex-direction: column;\n     justify-content:center;\n     width: 700px;\n     align-items: center;\n     border: 4px solid var(--brand-color);\n     background:var(--body-bg);\n     margin:auto;\n     border-radius: 20px;\n     padding:30px;\n}\n .bold-text {\n     font-weight: 700;\n}\n .top {\n     display:flex;\n     flex-direction:row;\n     width:600px;\n     justify-content:space-between;\n}\n .mid {\n     display:flex;\n     flex-direction:row;\n     align-items:top;\n     gap:30px;\n     margin-bottom:20px;\n}\n .main-info {\n     display:flex;\n     flex-direction:column;\n     box-shadow: var(--main-content-box-shadow);\n     width: 300px;\n     border-radius:20px;\n     padding:30px;\n}\n .bot {\n     display:flex;\n     flex-direction:column;\n     gap:50px;\n}\n .bio-display {\n     display:flex;\n     flex-direction:column;\n     box-shadow: var(--main-content-box-shadow);\n     width:600px;\n     border-radius:20px;\n     padding:30px;\n}\n .bio-display h3 {\n     text-align:left;\n     margin-bottom:0px;\n}\n p {\n     overflow-y: scroll;\n}\n a {\n     text-decoration:none;\n     color:var(--base-txt-color);\n     font-weight:700;\n}\n .point-display {\n     display:flex;\n     flex-direction:row;\n     justify-content:center;\n     gap:15px;\n     width:150px;\n     height:auto;\n     background: var(--brand-color);\n     color:#FFFFFF;\n     margin-top:5px;\n     margin-bottom:5px;\n     padding:5px;\n     padding-left:10px;\n     border-radius:20px;\n}\n #delete-btn {\n    /*Right-align element to parent */\n     margin-left: auto;\n     margin-right: 0;\n     width:150px;\n     padding:5px;\n     height: auto;\n     text-align:center;\n}\n #delete-btn::part(base) {\n     background:red;\n     border: 2px solid black;\n     border-radius:10px;\n     color:black;\n     font-weight:600;\n}\n sl-avatar {\n     --size: 200px;\n     margin-bottom: 1em;\n}\n @media all and (max-width: 768px){\n     .profile {\n         display:flex;\n         flex-direction: column;\n         justify-content:center;\n         width: 100vw;\n         align-items: center;\n         border:none;\n         border-radius:0px;\n         padding:20px;\n    }\n     .top {\n         width:90%;\n    }\n     .mid {\n         display:flex;\n         flex-direction:column;\n         width:90%;\n         align-items:left;\n    }\n     .bot {\n         width:90%;\n         gap:100px;\n    }\n     .bio-display {\n         width:90%;\n         border-radius:20px;\n         padding:20px;\n    }\n}\n\n\n  \n    \n    </style>\n    \n    \n              <div class=\"profile\">\n          <div class=\"top\">\n            <h1>Your Profile</h1>\n            <sl-icon-button name=\"pencil\" label=\"Edit Profile\" style=\"font-size: 2rem;\" @click=", "></sl-icon-button>\n          </div>\n          \n          <div class=\"mid\">\n                 ", "\n                 <div class=\"main-info\">\n                  <div><span class=\"bold-text\">Username </span><span>", "</span></div>\n                  <div><span class=\"bold-text\">Name </span><span>", " ", "</span></div>\n                  <div><span class=\"bold-text\">Email </span><span>", "</span></div>\n                 </div>\n          </div>\n          <div class=\"bot\">\n            <div class=\"bio-display\"><h3>Bio</h3>\n            <p>", "</p></div>\n  \n          </div>\n        </div>\n    \n                \n        "])), () => (0, _Router.gotoRoute)('/edit-profile'), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\" image=", "></sl-avatar>\n\t\t"])), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? "".concat(_enum.default.BUCKET_URI, "/").concat(_AuthAPI.default.currentUser.avatar) : '') : (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\"></sl-avatar>\n\t\t"]))), _AuthAPI.default.currentUser.username, _AuthAPI.default.currentUser.firstName, _AuthAPI.default.currentUser.lastName, _AuthAPI.default.currentUser.email, _AuthAPI.default.currentUser.bio);
  }
});
