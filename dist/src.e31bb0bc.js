...
},{"../App":"App.js","../Router":"Router.js","../Toast":"Toast.js","../utils/enum.utils":"utils/enum.utils.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js"}],"services/UserAPI.js":[function(require,module,exports) {
"use strict";
...
class UserAPI {
  ...
  async getPage(page, accessLevel) {
    ...
    //Convert json and store as data
    const data = await response.json();
    _AuthAPI.default.restaurantPage = data;
...
exports.default = _default;
},{"../App":"App.js","./AuthAPI":"services/AuthAPI.js"}],"views/pages/profile.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js"}],"utils/pagination.utils.js":[function(require,module,exports) {
"use strict";
...
class ReportAPI {
  ...
  async getPage(page, reportStatus, targetType) {
    ...
    //Convert json and store as data
    const data = await response.json();
    _AuthAPI.default.reportPage = data;
...
exports.default = _default;
},{"../App":"App.js","./AuthAPI":"services/AuthAPI.js","../Toast":"Toast.js"}],"views/pages/admin/search-reports.js":[function(require,module,exports) {
"use strict";
...
class SearchTicketsView {
  ...
  setupDropdownEvents() {
    ...
    statusDropdown.addEventListener('sl-select', event => {
      ...
      if (oldEl) oldEl.classList.remove("active-item");
      let newEl = statusDropdown.querySelector("sl-menu .".concat(event.detail.item.value));
    ...
    targetTypeDropdown.addEventListener('sl-select', event => {
      ...
      let newEl = targetTypeDropdown.querySelector("sl-menu .".concat(event.detail.item.value));
      newEl.classList.add("active-item");
    });
  }
  ...
  */
  ...
  async renderListings(data) {
    ...
    const listingTemplates = [];
    (0, _litHtml.render)(null, document.getElementById('reports-container'));
    _AuthAPI.default.targets = [];
    let count = 0;
    for (const item of data) {
      let target;
      if (item.targetType == _enum.default.reportTargetType.review) {
        target = await _ReviewAPI.default.getById(item.targetId);
        _AuthAPI.default.targets.push(target);
      } else if (item.targetType == _enum.default.reportTargetType.restaurant) {
        target = await _UserAPI.default.getById(item.targetId);
        _AuthAPI.default.targets.push(target);
      }
      listingTemplates.push((0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<report-listing index=", "></report-listing>"])), count));
      count++;
    }
...
class ReportView {
   ...
   */
  render() {
    _AuthAPI.default.currentReport = JSON.parse(localStorage.getItem("currentReport"));
    _AuthAPI.default.currentTarget = JSON.parse(localStorage.getItem("currentTarget"));
    let flaggedContent;
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../services/AuthAPI":"services/AuthAPI.js"}],"views/pages/reviews.js":[function(require,module,exports) {
"use strict";
...
class RestaurantView {
  ...
  async loadData(isNextPage) {
    ...
    //Find number of pages
    const numPages = await _ReviewAPI.default.getNumPages(this.restaurantId);
    //Disable/enable pagination buttons
    _pagination.default.updatePaginationButtons(numPages);

    //Get page of data
    const data = await _ReviewAPI.default.getPage(this.currPage, this.restaurantId, _enum.default.accessLevels.restaurant);
...
class App {
  constructor() {
    ...
    this.version = "1.0.0";
    //Establish the api url. Use this when testing the api live: 'https://grub-hunters-api.herokuapp.com';
...
exports.default = _default;
},{"./Router":"Router.js","./services/AuthAPI":"services/AuthAPI.js","./Toast":"Toast.js"}],"../node_modules/lit-html/lib/modify-template.js":[function(require,module,exports) {
"use strict";
...
var _default = mascot;
exports.default = _default;
},{"lit-html":"../node_modules/lit-html/lit-html.js"}],"components/base/header.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('app-header', class AppHeader extends _litElement.LitElement {
  ...
  navActiveLinks() {
    ...
    navLinks.forEach(navLink => {
      ...
      if (navLink.pathname === "/profile") if (currentPath === '/home' || currentPath === '/') navLink.classList.add('active');
    });
  }
...
customElements.define('register-form', class RegisterForm extends _litElement.LitElement {
  ...
  async registerSubmitHandler(e) {
    ...
    submitBtn.setAttribute('loading', '');
    _AuthAPI.default.signUp(formData, () => {}).then(() => {
      submitBtn.removeAttribute('loading');
    });
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../services/AuthAPI":"services/AuthAPI.js"}],"components/forms/create/report.component.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../services/AuthAPI":"services/AuthAPI.js","../../../Toast":"Toast.js","../../../services/ReportAPI":"services/ReportAPI.js"}],"components/forms/create/review.component.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../../Router":"Router.js","../../../services/AuthAPI":"services/AuthAPI.js","../../../Toast":"Toast.js","../../../services/UserAPI":"services/UserAPI.js","../../../utils/enum.utils":"utils/enum.utils.js"}],"components/list/review.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('review-listing', class ReviewListing extends _litElement.LitElement {
  ...
  buildReviewActions() {
    ...
    if (_AuthAPI.default.currentUser._id == this.review.authorId) {
      return (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n\t\t\t<div class=\"action-container\">\n\t\t\t\t<sl-button id=\"edit-btn\" @click=\"", "\">Edit</sl-button>  \n \t\t\t\t<sl-button id=\"delete-btn\" @click=\"", "\">Delete</sl-button>\n\t\t\t</div>  \n      "])), () => this.shadowRoot.getElementById('edit-dialog').show(), () => this.shadowRoot.getElementById('delete-dialog').show());
    }
  ...
  buildVoteDisplay() {
    ...
    //Enable voting for non-authors 
      ...
      return (0, _litElement.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      ", "\n      \n        ", ""])), this.review.upvoters.includes(_AuthAPI.default.currentUser._id) ? (0, _litElement.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral([" <div class=\"vote-container\">\n\t\t\t<sl-button id=\"upvote-btn\"\n\t\t\tdisabled @click=", ">Upvote</sl-button>\n\t\t\t<div>Upvotes: ", "</div>\n\t\t</div>"])), () => {
        this.voteReview('upvote');
      }, this.review.upvotes) : (0, _litElement.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral([" <div class=\"vote-container\">\n\t\t\t<sl-button id=\"upvote-btn\" @click=", ">Upvote</sl-button>\n\t\t\t<div>Upvotes: ", "</div>\n\t\t</div>"])), () => {
        this.voteReview('upvote');
      }, this.review.upvotes), this.review.downvoters.includes(_AuthAPI.default.currentUser._id) ? (0, _litElement.html)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["<div class=\"vote-container\">\n\t\t\t<sl-button id=\"downvote-btn\" disabled @click=", ">Downvote</sl-button>\n\t\t\t<div>Downvotes: ", "</div>\n\t\t</div>"])), () => {
        this.voteReview('downvote');
      }, this.review.downvotes) : (0, _litElement.html)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["<div class=\"vote-container\">\n\t\t\t<sl-button id=\"downvote-btn\" @click=", ">Downvote</sl-button>\n\t\t\t<div>Downvotes: ", "</div>\n\t\t</div>"])), () => {
        this.voteReview('downvote');
      }, this.review.downvotes));
    }
  }
...
customElements.define('report-listing', class ReportListing extends _litElement.LitElement {
  ...
  render() {
    ...
    return (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n\n<style>\n\n.bold-text {\n     font-size:var(--label-font-size);\n     font-weight:var(--label-font-weight);\n}\n .report-listing {\n     display:flex;\n     flex-direction: row;\n     width:500px;\n     margin:20px;\n     max-width:80vw;\n     padding:10px;\n     justify-content: space-between;\n     box-shadow: var(--main-content-box-shadow);\n     border-radius: 20px;\n}\n .left, .mid, .right {\n     display:flex;\n     flex-direction: column;\n     align-items:center;\n     justify-content:center;\n}\n .left, .mid {\n     padding:10px;\n     box-shadow:var(--main-content-box-shadow);\n     border-radius:10px;\n }\n .left {\n  width:250px;\n }\n .right {\n     justify-content:center;\n}\n sl-button {\n     width:100px;\n}\n sl-button::part(base) {\n     font-size:1rem;\n     font-weight:600;\n}\n\n</style>\n\n\n<div class=\"report-listing\">\n  <div class=\"left\">\n    <span class=\"bold-text\">Topic: ", "</span>\n  </div>\n    ", "\n<div class=\"right\">\n    <sl-button class=\"view-btn\" @click=", ">View Report</sl-button>\n</div>\n</div>"])), _AuthAPI.default.reportPage[this.index].topic, statusDisplay, event => {
      ...
      localStorage.setItem("currentTarget", JSON.stringify(_AuthAPI.default.targets[this.index]));
...
customElements.define('reviewer-profile', class ReviewerProfile extends _litElement.LitElement {
  ...
  render() {
    ...
    }, () => this.shadowRoot.getElementById('delete-dialog').hide(), () => (0, _Router.default)('/edit-profile'), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\" image=", " > </sl-avatar>\n\t\t"])), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? "".concat(_enum.default.BUCKET_URI, "/").concat(_AuthAPI.default.currentUser.avatar) : '') : (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\" > </sl-avatar>\n\t\t"]))), _AuthAPI.default.currentUser.username, _AuthAPI.default.currentUser.firstName, _AuthAPI.default.currentUser.lastName, _AuthAPI.default.currentUser.email, _AuthAPI.default.currentUser.demerits, _AuthAPI.default.currentUser.bio, () => this.shadowRoot.getElementById('delete-dialog').show());
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../services/UserAPI":"services/UserAPI.js","../../utils/enum.utils":"utils/enum.utils.js"}],"components/profile/restaurant.component.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../utils/enum.utils":"utils/enum.utils.js","../../services/UserAPI":"services/UserAPI.js","../../services/ReviewAPI":"services/ReviewAPI.js"}],"components/profile/admin.component.js":[function(require,module,exports) {
"use strict";
...
customElements.define('admin-profile', class AdminProfile extends _litElement.LitElement {
   ...
   */
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["   \n    \n    <style>\n\nh1 {\n     font-size: var(--h1-font-size);\n     font-weight:var(--h1-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n h2 {\n     font-size: var(--h2-font-size);\n     font-weight:var(--h2-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n h3 {\n     font-size: var(--h3-font-size);\n     font-weight:var(--h3-font-weight);\n     font-family:var(--heading-font-family);\n     color:var(--heading-txt-color);\n}\n .bold-text {\n     font-size:var(--label-font-size);\n     font-weight:var(--label-font-weight);\n}\n .profile {\n     display:flex;\n     flex-direction: column;\n     justify-content:center;\n     width: 700px;\n     align-items: center;\n     border: 4px solid var(--brand-color);\n     background:var(--body-bg);\n     margin:auto;\n     border-radius: 20px;\n     padding:30px;\n}\n .bold-text {\n     font-weight: 700;\n}\n .top {\n     display:flex;\n     flex-direction:row;\n     width:600px;\n     justify-content:space-between;\n}\n .mid {\n     display:flex;\n     flex-direction:row;\n     align-items:top;\n     gap:30px;\n     margin-bottom:20px;\n}\n .main-info {\n     display:flex;\n     flex-direction:column;\n     box-shadow: var(--main-content-box-shadow);\n     width: 300px;\n     border-radius:20px;\n     padding:30px;\n}\n .bot {\n     display:flex;\n     flex-direction:column;\n     gap:50px;\n}\n .bio-display {\n     display:flex;\n     flex-direction:column;\n     box-shadow: var(--main-content-box-shadow);\n     width:600px;\n     border-radius:20px;\n     padding:30px;\n}\n .bio-display h3 {\n     text-align:left;\n     margin-bottom:0px;\n}\n p {\n     overflow-y: scroll;\n}\n a {\n     text-decoration:none;\n     color:var(--base-txt-color);\n     font-weight:700;\n}\n .point-display {\n     display:flex;\n     flex-direction:row;\n     justify-content:center;\n     gap:15px;\n     width:150px;\n     height:auto;\n     background: var(--brand-color);\n     color:#FFFFFF;\n     margin-top:5px;\n     margin-bottom:5px;\n     padding:5px;\n     padding-left:10px;\n     border-radius:20px;\n}\n #delete-btn {\n    /*Right-align element to parent */\n     margin-left: auto;\n     margin-right: 0;\n     width:150px;\n     padding:5px;\n     height: auto;\n     text-align:center;\n}\n #delete-btn::part(base) {\n     background:red;\n     border: 2px solid black;\n     border-radius:10px;\n     color:black;\n     font-weight:600;\n}\n sl-avatar {\n     --size: 200px;\n     margin-bottom: 1em;\n}\n @media all and (max-width: 768px){\n     .profile {\n         display:flex;\n         flex-direction: column;\n         justify-content:center;\n         width: 100vw;\n         align-items: center;\n         border:none;\n         border-radius:0px;\n         padding:20px;\n    }\n     .top {\n         width:90%;\n    }\n     .mid {\n         display:flex;\n         flex-direction:column;\n         width:90%;\n         align-items:left;\n    }\n     .bot {\n         width:90%;\n         gap:100px;\n    }\n     .bio-display {\n         width:90%;\n         border-radius:20px;\n         padding:20px;\n    }\n}\n\n\n  \n    \n    </style>\n    \n    \n              <div class=\"profile\">\n          <div class=\"top\">\n            <h1>Your Profile</h1>\n            <sl-icon-button name=\"pencil\" label=\"Edit Profile\" style=\"font-size: 2rem;\" @click=", "></sl-icon-button>\n          </div>\n          \n          <div class=\"mid\">\n                 ", "\n                 <div class=\"main-info\">\n                  <div><span class=\"bold-text\">Username </span><span>", "</span></div>\n                  <div><span class=\"bold-text\">Name </span><span>", " ", "</span></div>\n                  <div><span class=\"bold-text\">Email </span><span>", "</span></div>\n                 </div>\n          </div>\n          <div class=\"bot\">\n            <div class=\"bio-display\"><h3>Bio</h3>\n            <p>", "</p></div>\n  \n          </div>\n        </div>\n    \n                \n        "])), () => (0, _Router.default)('/edit-profile'), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\" image=", "></sl-avatar>\n\t\t"])), _AuthAPI.default.currentUser && _AuthAPI.default.currentUser.avatar ? "".concat(_enum.default.BUCKET_URI, "/").concat(_AuthAPI.default.currentUser.avatar) : '') : (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([" <sl-avatar shape=\"rounded\"></sl-avatar>\n\t\t"]))), _AuthAPI.default.currentUser.username, _AuthAPI.default.currentUser.firstName, _AuthAPI.default.currentUser.lastName, _AuthAPI.default.currentUser.email, _AuthAPI.default.currentUser.bio);
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../../Router":"Router.js","../../services/AuthAPI":"services/AuthAPI.js","../../utils/enum.utils":"utils/enum.utils.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
